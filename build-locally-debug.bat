...
del /s /q %DST_DIR%
mkdir %CB_CROOT%
conda-build --croot %CB_CROOT% -m ..\..\a\conda_build_config-dbg.yaml . --python 3.7 --no-build-id -c rdonnelly --keep-old-work --dirty %CB_DEBUG% 2>&1 | C:\msys32\usr\bin\tee %CB_CROOT%\build.log
